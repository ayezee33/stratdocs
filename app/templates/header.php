...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
      <a class="nav-link" href="company-plan.php">
        <i class="fas fa-fw fa-lightbulb"></i>
        <span>Annual Strategic Plan</span>
      </a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="forecasts.php">
        <i class="fas fa-fw fa-pen"></i>
        <span>Projections & Forecasts</span>
      </a>
    </li>
    <!-- Nav Item - Utilities Collapse Menu -->
    <li class="nav-item">
      <a class="nav-link" href="team-plans.php">
